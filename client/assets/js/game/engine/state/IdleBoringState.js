...
export class IdleBoringState extends State {
	...
	get name() { return 'idle_boring'; }


	onEnter( $prevState ) {
		console.log('Entering idle_boring state from', $prevState);
		this.action = this.fsm.proxy.getAction('idle_boring');
	...
	onExit() {
		console.log('Exiting idle_boring state');
		this.cleanup();
	}
